def _procesar_compra_sistema_monolitico_block_1(carrito, usuario_id):
...
def _procesar_compra_sistema_monolitico_block_2(carrito, cupon_descuento=None):
    ...
    return item, total_final


def _procesar_compra_sistema_monolitico_block_3(total_final, usuario_id):
...
def _procesar_compra_sistema_monolitico_block_4(carrito, codigo_autorizacion, total_final, usuario_id):
...
def procesar_compra_sistema_monolitico(carrito, usuario_id, cupon_descuento=None):
    ...
    """
    item = _procesar_compra_sistema_monolitico_block_1(carrito, usuario_id)


    item, total_final = _procesar_compra_sistema_monolitico_block_2(carrito, cupon_descuento)


    codigo_autorizacion = _procesar_compra_sistema_monolitico_block_3(total_final, usuario_id)


    recibo_str = _procesar_compra_sistema_monolitico_block_4(carrito, codigo_autorizacion, total_final, usuario_id)
    return recibo_str
